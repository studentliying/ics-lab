...
## ID: 516030910444
## Declaration:
## 1. I complete the instruction of iaddq as I do in part B.
## 2. I optimize the situation when I use mrmovq and rmmovq
##    to avoid the stall and forward the value from execute stage. 
